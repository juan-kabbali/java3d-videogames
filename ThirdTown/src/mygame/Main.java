...
public class Main extends SimpleApplication
  ...
  public void simpleInitApp() {
    ...
    CapsuleCollisionShape capsuleShape = new CapsuleCollisionShape(1.0f, 0.5f, 1);
  ...
  @Override
    public void simpleUpdate(float tpf) {
        ...
        teaGeom.setLocalTranslation(player.getPhysicsLocation());
